...
public enum IdCardNFTFunctions {
  public struct balanceOf: ABIFunction {
   ...
   public struct getCurrentUserTier: ABIFunction {
    public static let name = "getCurrentUserTier"
    public let gasPrice: BigUInt?
    public let gasLimit: BigUInt?
    public var contract: EthereumAddress
    public let from: EthereumAddress?
   ...
   public struct supportsInterface: ABIFunction {
    ...
    public let _interfaceId: BigUInt
    ...
    public init(
        ...
        self.gasPrice = gasPrice
        self.gasLimit = gasLimit
        self._interfaceId = _interfaceId
        
    }

    public func encode(to encoder: ABIFunctionEncoder) throws {
      try encoder.encode(_interfaceId)
